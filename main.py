...
if __name__ == '__main__':
    ...
    parser.add_argument('--conv_algo', type=int, default=4, choices=[0,1,2,3,4], help='Conv2d algorithm 0-direct, 1-im2col, 2-im2colfused, 3-im2col_omp, 4-im2col_striped_omp (default: 4)')
